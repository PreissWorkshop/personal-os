...
| Leaving Iceland with a company: the three-year tax tail, Iceland's 22 % on the company's shares, where a company is resident, the low-tax company rule, missing treaties, New Zealand's four-year exemption, UAE company tax and free zones, Latvian residence | `references/tax-residency-and-exit.md` |
| Selling a course honestly: US income-claim and business-opportunity rules, testimonials and reviews, the EU and Icelandic 14-day withdrawal and its digital exception, always-unfair practices, Iceland's 2026 Marketing Act, UK ad code, what Meta, Google and TikTok refuse, how ads are billed, e-mail consent | `references/selling-rules-and-ads.md` |
| Letting property in Iceland: the two-flat tax ceiling, the 25 % exemption, home letting and its caps, why the licensed route is shut in town, neighbours' consent, tenancy law, the letting intermediary licence, real rents, yields against a savings account, short-let demand and what it costs to run | `references/iceland-letting.md` |
| Buying distressed property in Iceland: where forced sales and estates are published, the auction process end to end, taking over charges instead of paying cash, which charges survive, the statutory path from a neglected building to an auction, and checking heritage protection first | `references/iceland-distressed-property.md` |
