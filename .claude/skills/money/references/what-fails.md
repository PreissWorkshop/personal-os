...
| Day trading for a living (Brazil futures) | "who persisted for at least 300 days: 97% of them lost money, only 0.4% earned more than a bank teller (US$54 per day)" [V 2026-09-20]; the SSRN abstract's wording "97% of all individuals who persisted for more than 300 days lost money."; "only 1.1% earned more than the Brazilian minimum wage" stays [S] | all new day traders 2013-15, administrative data; the strongest study here | Chague, De-Losso, Giovannetti; [V 2026-09-20] on the RePEc record of the FGV working-paper version, ideas.repec.org/p/fgv/eesptd/525.html, read on the page; SSRN 3423101 answers 403 to scripts, a headless browser and the fetch tool |
...
| Retail bitcoin buyers 2015-22 | est. "73-81% of retail investors have likely lost money on their initial investment" | model-based on app downloads, 95 countries; "estimated", not observed P&L | BIS Working Paper 1049 (Auer et al. 2022), bis.org/publ/work1049.htm [V 2026-09-20], read on the abstract page. Corrected source: was BIS Bulletin 69; its PDF, read 2026-09-20, has no 73 or 81 - it says "a majority of investors probably lost money on their bitcoin investment" and, investing monthly, "over four fifths of users would have lost money" |
| MLM distributors (AdvoCare 2016) | "72.3 percent of distributors did not earn any compensation from AdvoCare; another 18 percent earned between one cent and $250" | company data cited by the regulator | FTC 2019-10 release [V 2026-09-20], both sentences read on the page (ftc.gov answers a browser-style fetch; 403 only to the script) |
...
| New US employer establishments | "77.9% of new establishments survive year one, 51.4% survive five years, and 34.7% survive a decade." | payroll establishments only; solo online businesses not counted, almost certainly worse | BLS BED to Mar 2025 via third party [S] - these three figures are not on the BLS page checked. [V 2026-09-20], read in a browser: bls.gov TED 2024-03-04 publishes 1-year survival rates by census division, from "71.4 percent for establishments born in 2008" (South Atlantic) to "84.6 percent of establishments born in 2021" (Pacific) |
...
|---|---|---|
| Ecommerce Empire Builders (complaint Sept 2024, order May 2025) | "In social media ads, EEB claims that its clients can make $10,000 monthly, but the FTC's complaint alleges that the company has no evidence to back up those claims."; "'done for you' online storefronts that cost consumers as much as $35,000"; ~$2,000 training; owner banned from selling business opportunities | [V 2026-09-20] on the ftc.gov 2025-05 release, read on the page, for "training programs that cost nearly $2,000", "as much as $35,000", "promised consumers profits of $10,000 each month, but the complaint charged that these profits never materialized" and "permanently bans them from selling business opportunities of any kind"; the "In social media ads ... no evidence" sentence is not on that page (probably the Sept 2024 release) and stays [S] |
