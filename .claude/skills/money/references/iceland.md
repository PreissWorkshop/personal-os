...
|---|---|---|---|
| ehf minimum share capital | ISK 500,000; one founder is enough | [S] | skatturinn.is/fyrirtaekjaskra/stofnun-felaga/einkahlutafelog/ |
| ehf registration fee | ISK 140,500 (changes yearly - verify) | [S] | skatturinn.is/.../einkahlutafelog/verklagsreglur/ |
...
| Item | Value | Label | Source |
|---|---|---|---|
| Registration threshold | ISK 2,000,000 taxable turnover in any 12 months | [S] | skatturinn.is/english/companies/value-added-tax/ via stripe.com iceland-vat-guide, anrok.com |
| Rates | 24 % standard, 11 % reduced | [S] | avalara.com, quaderno.io Iceland guides |
...
| Item | Value | Label | Source |
|---|---|---|---|
| Bracket 1 | 31.49 % up to ISK 498,122 / month | [S] | skatturinn.is/einstaklingar/stadgreidsla/skattthrep/2026/ |
| Bracket 2 | 37.99 % up to ISK 1,398,450 / month | [S] | same |
| Bracket 3 | 46.29 % above | [S] | same |
| Personal tax credit (persónuafsláttur) | ISK 72,492 / month, ISK 869,898 / year | [S] | skatturinn.is/einstaklingar/stadgreidsla/stadgreidsla/2026/ |
...
| Capital income tax (dividends, interest, gains) | 22 % | [S] | skatturinn.is fjarmagnstekjuskattur; PwC |
| Tryggingagjald (social security contribution) | 6.35 % of wages / reiknað endurgjald | [S] | skatturinn.is tryggingagjald; freelancepay.is |
...
| Class D guideline 2026 | ISK 589,000-969,000 / month by size of operation (single secondary source; a one-person shop is normally the lowest sub-class) | [S] | new.freelancepay.is/is/reiknad-endurgjald |
...
| Dividend withholding | 22 % on domestic dividends to individuals; 20 % to foreign legal entities | [S] | skatturinn.is fjarmagnstekjuskattur |
...
| Item | Value | Label | Source |
|---|---|---|---|
| Central Bank key rate | 8.00 % after +0.25 on 19 Aug 2026 (vote 4-1); path 7.25 % (Feb) → 7.50 % (18 Mar) → 7.75 % (May, inferred) → 8.00 % (Aug) | [S], May step [I] | sedlabanki.is yfirlýsing 2026-02-04, 2026-03-18, 2026-08-19; dv.is 2026-08-19 |
| Inflation | 12-month CPI 5.3 % in July 2026 (5.2 % June); target 2.5 %; above 5 % all year; August figure not found | [S] | hagstofa.is vísitala neysluverðs júní 2026; mbl.is 2026-07-23 |
| Overdraft and credit-card revolving rate | Arion 15.25 % after the March 2026 hike; Íslandsbanki +0.25 pp the same month; after August likely ~15.5 % | [S], August level [I] | visir.is 2026 "bankarnir byrjaðir að hækka vexti"; bank price lists (not opened) |
...
| Cost of UMS help | free (Act 100/2010); UMS tel. 512 6600 per island.is | [S] | althingi.is/lagas/nuna/2010100.html |
...
| Limitation (Act 150/2007) | general claims 4 years; money loans, bonds and securities-depository claims 10 years; judgment claims 10 years; interrupted by acknowledgement or legal action | [S], judgment/interruption [I] | althingi.is/lagas/nuna/2007150.html; skemman.is/handle/1946/20217 |
...
| Item | Value | Label | Source |
|---|---|---|---|
| Tax residence | follows domicile/registration; more than 183 days in any 12 months creates residence; a former resident stays **fully tax-liable for 3 years after leaving unless they prove they became taxable in another country** (a general rule, not a low-tax-country rule) | [S], 183-day part [I] | taxsummaries.pwc.com/iceland/individual/residence; skatturinn.is/english/individuals/tax-liability/ |
...
|---|---|---|---|
| Stripe | **not in the published lists of Stripe's 46 supported merchant countries** (Denmark, Finland, Norway, Sweden, Estonia are); ISK appears only as a presentment currency, which is not merchant availability; stripe.com/global itself could not be opened - confirm there first | [S] secondary | dodopayments.com stripe-supported-countries; rapyd.net blog |
...
| Lemon Squeezy (merchant of record) | Iceland listed for bank payouts | [S] | docs.lemonsqueezy.com supported-countries |
| Payoneer | Iceland listed as supported | [S] | payoneer.custhelp.com a_id/45754 |
