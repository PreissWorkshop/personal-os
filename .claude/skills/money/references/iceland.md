...
| ehf registration fee | ISK 140,500 (changes yearly - verify) | [S] - page fetched 2026-09-20, no 140,500 on it; find the current gjaldskrá | skatturinn.is/.../einkahlutafelog/verklagsreglur/ |
...
| Capital income tax (dividends, interest, gains) | 22 % | [S] - skatturinn page fetched 2026-09-20, "22" not in its text; confirm by eye or in the PwC summary | skatturinn.is fjarmagnstekjuskattur; PwC |
...
| Item | Value | Label | Source |
|---|---|---|---|
| Central Bank key rate | 8.00 % after +0.25 on 19 Aug 2026 (vote 4-1); path 7.25 % (Feb) → 7.50 % (18 Mar) → 7.75 % (May, inferred) → 8.00 % (Aug) | [S], May step [I] - the 19 Aug webcast page carries no rate figure (fetched 2026-09-20); open the yfirlýsing itself | sedlabanki.is yfirlýsing 2026-02-04, 2026-03-18, 2026-08-19; dv.is 2026-08-19 |
...
|---|---|---|---|
| Stripe | **not in the published lists of Stripe's 46 supported merchant countries** (Denmark, Finland, Norway, Sweden, Estonia are); ISK appears only as a presentment currency, which is not merchant availability; stripe.com/global fetched 2026-09-20 from main-pc: no "Iceland" in the page text (weak if the country list is script-rendered - check in a browser that other countries show) | [V 2026-09-20] absence, with that caveat; the 46-country detail [S] | stripe.com/global; dodopayments.com stripe-supported-countries; rapyd.net blog |
